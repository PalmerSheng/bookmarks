      ...
      <div class="translator-wrapper">
        ...
        <div class="translator-card">
          ...
          <div class="method-selection">
            <h3>{{ $t('translator.method') }}</h3>
            <div class="method-buttons">
              <button 
                @click="translationMethod = 'google'"
                :class="['method-btn', { active: translationMethod === 'google' }]"
              >
              ...
              <button 
                @click="translationMethod = 'ai'"
                :class="['method-btn', { active: translationMethod === 'ai' }]"
              >
                <svg class="method-icon" viewBox="0 0 24 24">
